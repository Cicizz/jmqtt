...
import org.jmqtt.broker.store.rdb.daoobject.SubscriptionTenant;
...
public interface SubscriptionMapper {
    ...
    Long storeSubscription(SubscriptionTenant subscriptionDO);
    ...
    List<SubscriptionTenant> querySubscription(String clientId);
}
