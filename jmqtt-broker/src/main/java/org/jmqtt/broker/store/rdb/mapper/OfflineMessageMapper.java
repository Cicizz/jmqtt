...
import org.jmqtt.broker.store.rdb.daoobject.OfflineMessageTenant;
...
public interface OfflineMessageMapper {
    ...
    Long storeOfflineMessage(OfflineMessageTenant offlineMessageDO);
    ...
    List<OfflineMessageTenant> getAllOfflineMessage(String clientId);
}
